...
client.on("guildMemberAdd", async (member) => {
  ...
  const welcomeEmbed = new Discord.MessageEmbed()
    ...
    .addFields(
      ...
      { name: "💬┊・chat", value: "1154680534363017226", inline: true }, // channel
      {
        name: "・▌ديــوان ابـو انور ▌・",
        value: "1071385065524830258", // channel
        inline: true,
      },
    )
  ...
  const row = new MessageActionRow().addComponents(
    new MessageButton()
      .setStyle("LINK")
      .setURL("https://discord.gg/bb9") // link to button 1
      .setLabel("b9") // name of button 1
      .setEmoji("<a:11621546711342285001:1278977791819518036> "), // emoji of button 1
    new MessageButton()
      .setStyle("LINK")
      .setURL("https://discord.gg/bb9") // link to button 2
      .setLabel("b9") // name of button 2
      .setEmoji("<:R_:1278422175858294876>"), // emoji of button 2
    new MessageButton()
      .setStyle("LINK")
      .setURL("https://discord.gg/bb9") // link to button 3
      .setLabel("b9") // name of button 3
      .setEmoji("<a:10775725738161808481:1276142825972432906>"), // emoji of button 3
  );
